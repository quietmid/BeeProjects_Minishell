...
/*   Updated: 2024/06/21 17:58:28 by pbumidan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_forks(t_data *data)
{
	...
	data->pid = (pid_t*)malloc(sizeof(pid_t) * (data->cmd_count));
	if (!data->pid)
